...
const RadialGradientControls: React.FC<RadialGradientControlsProps> = ({
  ...
  return (
    <div className="mt-4">
      <h3 className="text-lg font-medium mb-3">Ocean Radial Effect</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="col-span-1 md:col-span-2 bg-gray-600 p-3 rounded-md">
          <p className="text-sm">
            ...
            land masses. Adjust the center position, inner radius, and falloff
            to control the shape and size of continents. Increasing strength
            makes the ocean effect more prominent.
          </p>
        </div>
      </div>
    </div>
